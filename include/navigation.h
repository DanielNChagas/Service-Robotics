...
private:
    ...
    private:
        static constexpr int numExplorePathTurns = 20;
        static constexpr int explorePathTurns[20][2] = {
            {3, 16}, {1, -1}, {-1, 14}, {0, 13}, {1, -1}, {1, -1}, {1, -1}, {-1, -1}, {1, 3}, {0, 4}, {-1, -1}, {0, 7}, {0, 8}, {1, -1}, {1, 12}, {0, 11}, {-1, 10}, {1, -1}, {-1, 14}, {-1, -1}};
